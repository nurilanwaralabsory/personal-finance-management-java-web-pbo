...
<%
    ...
    String pageTitle = isEdit ? "Edit Pengeluaran" : "Tambah Pengeluaran";
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="d-flex align-items-center mb-4">
                <a href="<%= request.getContextPath() %>/expenses" class="btn btn-icon btn-text-secondary me-3">
                  <i class="ri ri-arrow-left-line"></i>
                </a>
                <div>
                  <h4 class="mb-0"><%= pageTitle %></h4>
                  <p class="text-muted mb-0">Masukkan detail pengeluaran Anda</p>
                </div>
              </div>
                    ...
                    <div class="card-body">
                      <form action="<%= request.getContextPath() %>/expenses" method="post">
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="input-group">
                              ...
                              <input type="number" class="form-control" id="amount" name="amount" 
                                     value="<%= isEdit ? expense.getAmount().longValue() : "" %>" 
                          ...
                          <!-- Tanggal -->
                          <div class="col-md-6">
                            <label class="form-label" for="expenseDate">Tanggal <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="expenseDate" name="expenseDate" 
                                   value="<%= isEdit ? dateFormat.format(expense.getExpenseDate()) : todayDate %>" required>
                          </div>
                          ...
                          <div class="col-md-6">
                            ...
                            <select class="form-select" id="categoryId" name="categoryId">
                              ...
                              <option value="<%= cat.getId() %>" 
                                      <%= isEdit && expense.getCategoryId() != null && expense.getCategoryId() == cat.getId() ? "selected" : "" %>>
                                <%= cat.getName() %>
                              </option>
                              <% } } %>
                            </select>
                            <div class="form-text">
                              <a href="<%= request.getContextPath() %>/categories?action=add&type=expense">+ Tambah kategori baru</a>
                            </div>
                          </div>
                          
                          <!-- Penerima -->
                          <div class="col-md-6">
                            <label class="form-label" for="recipient">Penerima</label>
                            <input type="text" class="form-control" id="recipient" name="recipient" 
                                   value="<%= isEdit && expense.getRecipient() != null ? expense.getRecipient() : "" %>" 
                                   placeholder="Contoh: Toko ABC, Warung Makan, dll">
                          </div>
                          ...
                          <div class="col-12">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" 
                                      placeholder="Masukkan deskripsi pengeluaran (opsional)"><%= isEdit && expense.getDescription() != null ? expense.getDescription() : "" %></textarea>
                          </div>
                ...
                <div class="col-lg-4">
                  <div class="card bg-label-danger">
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled mb-0 small">
                        <li class="mb-2">• Catat pengeluaran segera setelah transaksi</li>
                        <li class="mb-2">• Gunakan kategori yang sesuai untuk analisis</li>
                        <li class="mb-2">• Tambahkan penerima untuk melacak tujuan</li>
                  ...
                  <div class="card mt-3">
                    <div class="card-body">
                      ...
                      <% } } else { %>
                      <p class="text-muted small mb-0">Belum ada kategori. <a href="<%= request.getContextPath() %>/categories?action=add&type=expense">Tambah sekarang</a></p>
                      <% } %>
                    </div>
                  </div>
                </div>
