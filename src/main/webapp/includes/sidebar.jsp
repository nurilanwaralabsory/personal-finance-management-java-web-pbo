...
<aside id="layout-menu" class="layout-menu menu-vertical menu">
  ...
  <ul class="menu-inner py-1">
    ...
    <!-- Transactions -->
    <li class="menu-item <%= "transactions".equals(activePage) || "income".equals(activePage) || "expense".equals(activePage) ? "active open" : "" %>">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon icon-base ri ri-exchange-funds-line"></i>
        <div data-i18n="Transaksi">Transaksi</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item <%= "transactions".equals(activePage) ? "active" : "" %>">
          <a href="transactions.jsp" class="menu-link">
            <div data-i18n="Semua Transaksi">Semua Transaksi</div>
          </a>
        </li>
        <li class="menu-item <%= "income".equals(activePage) ? "active" : "" %>">
          <a href="income.jsp" class="menu-link">
            <div data-i18n="Pemasukan">Pemasukan</div>
          </a>
        </li>
        <li class="menu-item <%= "expense".equals(activePage) ? "active" : "" %>">
    ...
    <!-- Categories -->
    <li class="menu-item <%= "categories".equals(activePage) ? "active" : "" %>">
    ...
    <!-- Budgets -->
    <li class="menu-item <%= "budgets".equals(activePage) ? "active" : "" %>">
    ...
    <li class="menu-item <%= "profile".equals(activePage) ? "active" : "" %>">
    ...
    <li class="menu-item <%= "settings".equals(activePage) ? "active" : "" %>">
