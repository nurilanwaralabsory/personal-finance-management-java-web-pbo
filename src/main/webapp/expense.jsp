...
<html
  ...
  <head>
    ...
    <title>Tambah Pengeluaran - Manajemen Keuangan Pribadi</title>
    <!-- Common CSS -->
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <jsp:include page="includes/sidebar.jsp">
          <jsp:param name="activePage" value="expense" />
        </jsp:include>
        <!-- / Menu -->
        <!-- / Menu -->
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
               <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <span class="fw-bold text-danger">Tambah Pengeluaran Baru</span>
                </div>
              </div>
            </div>
           </nav>
                      ...
                      <form action="transactions" method="POST">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <input type="number" step="0.01" class="form-control" id="amount" name="amount" placeholder="50000" required />
                          </div>
                        </div>
                        ...
                        <div class="mb-3">
                          ...
                          <textarea id="description" name="description" class="form-control" placeholder="Apa yang Anda beli?"></textarea>
                        </div>
