...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        if (recentIncomes == null) recentIncomes = new ArrayList<>();
        if (recentExpenses == null) recentExpenses = new ArrayList<>();
        ...
        request.setAttribute("recentIncomes", recentIncomes.size() > 3 ? recentIncomes.subList(0, 3) : recentIncomes);
        request.setAttribute("recentExpenses", recentExpenses.size() > 3 ? recentExpenses.subList(0, 3) : recentExpenses);
