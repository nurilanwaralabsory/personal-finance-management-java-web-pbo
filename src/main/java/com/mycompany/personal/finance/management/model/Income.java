...
public class Income {
    ...
    public Income(int id, BigDecimal jumlah, Date tanggal, String deskripsi, int kategoriId, String kategoriNama) {
        this.id = id;
        this.jumlah = jumlah;
    ...
    public Income(BigDecimal jumlah, Date tanggal, String deskripsi, int kategoriId) {
        this.jumlah = jumlah;
        this.tanggal = tanggal;
        this.deskripsi = deskripsi;
        this.kategoriId = kategoriId;
